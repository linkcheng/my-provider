...
# Generation Time: 2020-06-10 06:28:40 +0000
# ************************************************************
...
CREATE TABLE `permissions` (
  ...
  UNIQUE KEY `uk_role_perm` (`role`,`resource`,`action`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='permissions';
